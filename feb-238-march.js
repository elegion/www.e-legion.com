...
function happy238Holidays() {
  var $objects = $(".genders-holiday__ufo");
  var actClass = "genders-holiday__ufo_active";
  $objects.removeClass(actClass);

  var count = $objects.length;
  var random = Math.floor(Math.random() * count);
  $objects.eq(random).addClass(actClass);
}
